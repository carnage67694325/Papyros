...
class CommentRemoteDataSourceImpl implements CommentRemoteDataSource {
  ...
  @override
  Future<void> addComment(CommentModel comment, String token) async {
    await dio.post(
      '${ApiService.baseUrl}${Endpiont.addCommentEndpoint}',
      data: comment.toJson(),
      options: Options(headers: {'Authorization': 'Bearer $token'}),
    );
  }
  ...
  @override
  Future<void> editComment(String commentId, String newText, String token) async {
    await dio.put(
  ...
  @override
  Future<void> replyToComment(String commentId, CommentModel reply, String token) async {
    await dio.post(
