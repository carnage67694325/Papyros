...
class SignuprepoImp extends Signuorebo{
  ...
  @override
  Future<Either<SignupEntity, String>> Signup({required String firstname, required String lastname, required String email, required String password, required String confirmPassword, required String phone}) async {
    var result = await signupApi.Signup(email: email, password: password, phone: phone, firstname: firstname, lastname: lastname, confirmPassword: confirmPassword);
